...
import { allUser, deleteUser, followAndUnfollowUser, login, logout, registerUser, findFollowing, findFollowers, findAUser, findMe } from '../controller/userController.js';
...
userRouter.route('/findme/:id').get(protect, findMe)
